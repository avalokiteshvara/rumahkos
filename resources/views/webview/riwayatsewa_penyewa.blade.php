        ...
        <div class="col-12" >
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item"><b>Komentar Anda</b> <br/>{{ $d->rating_komentar }}</li>
                </ul>
                <div class="card-body">
                    <!-- <a href="#" class="card-link">Card link</a> -->
                    <!-- <a href="#" class="card-link">Another link</a> -->
                    <button onclick="showRatingDialog({{ $d->id }} ,{{ $d->rating_nilai}}, '{!! base64_encode($d->rating_komentar)  !!}' )" type="button" class="btn btn-warning float-right m-3">Edit</button>
                </div>
            </div>
        </div>
        <script>
